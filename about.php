...
<head>
    ...
    <script type="text/javascript" src="jqPuzzle/jquery.js"></script>
<script type="text/javascript" src="jqPuzzle/jquery.jqpuzzle.js"></script> 
...
<body>
    ...
    complete: function () {
        ...
        <section class="aboutme">
            ...
            <article style="background: url(images/lester.jpg) no-repeat 0 5px; clear: both;">
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a title="About Me" href="#" aria-haspopup="true">About Me</a>
