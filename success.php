...
<body>
    ...
    <div id="page">
        ...
        <section class="aboutme">
            <article>
                <p>
                    <h2>Thank you for contacting me!</h2><br />
                </p>
                <p style="text-align:justify; font-weight:bold; font-size:medium; ">
                   I am delighted to have the opportunity to serve you and will respond to your inquiry shortly.
                </p>


                <a class="btn" title="Click here to return to main page" href="default.html">Return</a>
