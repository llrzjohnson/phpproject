...
<div class="container">
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td>Contact No</td>
            <td><input type='text' name='contact_no' class='form-control' value="<?php echo $contact_no; ?>" required data-masked-input="999-999-9999" placeholder="XXX-XXX-XXXX" maxlength="12"></td>
        </tr>
